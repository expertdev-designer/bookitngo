class HotelMapListingResponse {
  bool _status;
  String _message;
  List<HotelMapData> _data;

  HotelMapListingResponse({bool status, String message, List<HotelMapData> data}) {
    this._status = status;
  ...
  List<HotelMapData> get data => _data;
  set data(List<HotelMapData> data) => _data = data;

  HotelMapListingResponse.fromJson(Map<String, dynamic> json) {
    _status = json['status'];
    _message = json['message'];
    if (json['data'] != null) {
      _data = new List<HotelMapData>();
      json['data'].forEach((v) {
        _data.add(new HotelMapData.fromJson(v));
      });
    }
  }
...
class HotelMapData {
  ...
  HotelMapData(
    ...
    this._cancelSetting = cancelSetting;
    this._rating = rating;
  ...
  HotelMapData.fromJson(Map<String, dynamic> json) {
    ...
    _cancelSetting = json['cancel_setting'];
    _rating = json['rating'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['cancel_setting'] = this._cancelSetting;
