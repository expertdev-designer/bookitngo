...
class _ExpansionTileState extends State<MyExpansionCard>
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                            ...
                            Container(
                                decoration: BoxDecoration(
                                      boxShadow: [
                                        BoxShadow(
                                          blurRadius: 5,
                                          color: Color.fromRGBO(117,117,170,0.08),
                                          offset: Offset(0,5)
                        ...
                        trailing: widget.trailing ??
                            RotationTransition(
                              turns: _iconTurns,
                              child: const Icon(Icons.expand_more,color: Color(0xFF09314F),),
                            ),
                        ),
                  )),
              ClipRect(
