...
class SanFrancisco extends StatefulWidget {
  String title, userId;
  SanFrancisco({this.title, this.userId});

  @override
  _SanFranciscoState createState() => _SanFranciscoState();
}

class _SanFranciscoState extends State<SanFrancisco> {
  @override
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Container(
              ...
              child: Text(
                "SanFrancisco is a city outside Los Angeles, in Southern California. It's home to the Disneyland Resort, a massive complex of family-friendly, Disney-themed rides, restaurants, hotels and shops. The city's also home to pro sports teams.",
                style: TextStyle(
                    fontFamily: "Sofia",
        ...
        Container(
          ...
          child: StreamBuilder(
            stream: Firestore.instance
                .collection("discover")
                .where("location", isEqualTo: 'San Francisco')
                .snapshots(),
