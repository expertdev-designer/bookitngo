...
//                           profileImageUrl: linkedInUser?.profilePicture?.displayImageContent?.elements[0]?.identifiers[0]?.identifier,id:linkedInUser.userId
//                         );
//
//                         setState(() {
//                           logoutUser = false;
...
//
// class UserObject {
//   String firstName, lastName, email, profileImageUrl,id;
//
//   UserObject({this.firstName, this.lastName, this.email, this.profileImageUrl,id});
// }
