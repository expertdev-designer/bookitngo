...
class BookItCreditCardForm extends StatefulWidget {
  const BookItCreditCardForm({
    Key key,
    this.cardNumber,
    this.expiryDate,
    this.cardHolderName,
    ...
    this.dateValidationMessage = 'Please    enter a valid date',
    this.numberValidationMessage = 'Please enter a valid number',
    this.cardHolderValidationMessage="Please enter a card holder name"
  }) : super(key: key);
  ...
  @override
  _BookItCreditCardFormState createState() => _BookItCreditCardFormState();
}

class _BookItCreditCardFormState extends State<BookItCreditCardForm> {
  String cardNumber;
  String expiryDate;
