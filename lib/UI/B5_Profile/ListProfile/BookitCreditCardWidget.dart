...
const Map<CardType, String> CardTypeIconAsset = {
  ...
  class BookITCreditCardWidget extends StatefulWidget {
  const BookITCreditCardWidget({
    Key key,
    ...
    this.labelCardHolder = 'CARD HOLDER NAME',
  ...
  @override
  _BookITCreditCardWidgetState createState() => _BookITCreditCardWidgetState();
}

class _BookITCreditCardWidgetState extends State<BookITCreditCardWidget> with SingleTickerProviderStateMixin {
